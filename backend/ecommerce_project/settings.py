...
CORS_ALLOWED_ORIGINS = os.environ.get(
    ...
    'http://localhost:3000,http://localhost:5173,http://127.0.0.1:3000,http://127.0.0.1:5173,http://localhost:8080,https://choy-apparel-0-3.onrender.com,choy-apparel-0-3.onrender.com'
).split(',')
